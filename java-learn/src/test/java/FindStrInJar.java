                    ...
                    if (filename.endsWith(".jar") || filename.endsWith(".zip")) {
                        ...
                        while (entries.hasMoreElements()) {
                            ...
                            while (r.read() != -1) {
                                ...
                                if (null != tempStr && tempStr.contains(condition)) {
...
//                            }
    ...
    public static void main(String args[]) {
        FindStrInJar findInJar = new FindStrInJar("Aspose Pty Ltd"); //要寻找的字符串
        List<String> jarFiles = findInJar.find("E:\\code\\lazyjee-promotion-ctj\\lazyjee-promotion-ctj-application\\src\\main\\resources\\lib", true);
        if (jarFiles.size() == 0) {
