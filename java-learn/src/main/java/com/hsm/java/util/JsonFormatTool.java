...
public class JsonFormatTool {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String str = "";
        FileInputStream fileInputStream = new FileInputStream(new File("E:\\github\\java-interview\\java-learn\\src\\main\\java\\com\\hsm\\java\\util\\1.json"));
        int lenght = fileInputStream.available();
        byte[] buffer = new byte[lenght];
        fileInputStream.read(buffer);
        fileInputStream.close();
        str = new String(buffer, StandardCharsets.UTF_8); // 关键之处
